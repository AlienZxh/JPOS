 ...
 */
public class AutoExpandableLinearLayout extends AutoLinearLayout {
    ...
    public AutoExpandableLinearLayout(Context context) {
        super(context);
        init(null);
    }

    public AutoExpandableLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public AutoExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AutoExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            expanded = a.getBoolean(net.cachapa.expandablelayout.R.styleable.ExpandableLayout_el_expanded, false);
            a.recycle();
        }
    ...
    public static class LayoutParams extends AutoLinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, net.cachapa.expandablelayout.R.styleable.ExpandableLayout);
            expandable = a.getBoolean(net.cachapa.expandablelayout.R.styleable.ExpandableLayout_layout_expandable, false);
